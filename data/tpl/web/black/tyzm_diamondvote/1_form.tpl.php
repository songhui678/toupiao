	  ...
	  <div class="form-group">
		...
		<div class="form-group">
		  ...
		  <div class="form-controls  col-sm-4">
   	    ...
   	    <div class="form-group">
          <label class="control-label col-sm-2">首页显示报名人数</label>
		  <div class="form-controls  col-sm-4">
            <div class="input-group">
              <input class="form-control" type="text" value="<?php  echo $reply['listnum'];?>"name="listnum">
              <span class="input-group-addon">个</span>
            </div>
			<div class="help-block">首页显示== 每次加载多少个报名用户</div>
          </div>
        </div>
	<div class="form-group">

...
<ul class="we7-page-tab">
	<li class="active"><a href="<?php  echo url('statistics/account-analysis');?>">所有公众号访问统计</a></li>
</ul>
<div class="api">
	...
	<div class="panel we7-panel" id="js-system-account-analysis" ng-controller="systemAccountAnalysisCtrl" ng-cloak>
		...
		<div class="panel-body data-view">
			...
			<div class="col-sm-12">
				<canvas class="chart chart-line" chart-options="options" chart-data="data" chart-labels="labels" chart-colors="colors"></canvas>
			</div>
		</div>
	</div>
</div>
<script>
require(['angular-chart', 'daterangepicker'], function() {

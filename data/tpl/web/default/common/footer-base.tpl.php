	...
	<div class="container-fluid footer text-center" role="footer">	
		<div class="friend-link">
			<?php  if(empty($_W['setting']['copyright']['footerright'])) { ?>
				<a href="http://www.we8.club">微信开发</a>
				<a href="http://we8.club">微信应用</a>
				<a href="http://www.we8.club">维吧社区</a>
				<a href="tencent://message/?uin=1582077961&Site=联系客服&Menu=yes">联系客服</a>
			<?php  } else { ?>
				<?php  echo $_W['setting']['copyright']['footerright'];?>
			<?php  } ?>
		</div>
		<div class="copyright"><?php  if(empty($_W['setting']['copyright']['footerleft'])) { ?>Powered by <a href="http://www.we8.club"><b>维吧</b></a> v<?php echo IMS_VERSION;?> &copy; 2014-2015 <a href="http://www.we8.club">www.we8.club</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerleft'];?><?php  } ?></div>
	</div>
